...
<body>
    ...
    <br><br><br>
    <blockquote cite="https://www.lttstore.com/pages/terms-and-conditions">
        <h1>Terms and Conditions</h1>
        <br>
        <br>
        <h4>OVERVIEW</h4>
        <br>
        <P>This website is operated by COMP3340 Group project. Throughout the site, the terms “we”, “us” and “our” refer
            to this website. we offers this website, including all information, tools and
        ...
        <P>We are not liable for any harm or damages related to the purchase or use of goods, services, resources,
            ...
            transaction. </P>
        <p>Complaints, claims, concerns, or questions regarding third-party products should be directed to the
            third-party.
        </p>
        <br>
        ...
        <p>We may, but have no obligation to, monitor, edit or remove content that we determine in our sole discretion
            ...
            or violates any party’s intellectual property or these Terms of Service.</p>
        ...
        <br>
        <P>Your submission of personal information through the store is governed by our Privacy Policy. View our <a href="./PrivacyPolicy.html">Privacy Policy</a> </P>
        <br>
        ...
        <p>You expressly agree that your use of, or inability to use, the service is at your sole risk. The service and
            ...
            merchantable quality, fitness for a particular purpose, durability, title, and non-infringement.</p>
        <p>In no case shall our site, our directors, officers, employees, affiliates, agents, contractors, interns,
            ...
            the service or any product, including, but not limited to, any errors or omissions in any content, or any
        ...
        <br>
        <p>You agree to indemnify, defend and hold harmless our site, subsidiaries,
        ...
        <p>These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and
            construed in accordance with the laws of Canada.</p>
        <br>
        ...
        <br>
        <p>Questions about the Terms of Service should be sent to us at support@email.com
        </p>
        <br>
